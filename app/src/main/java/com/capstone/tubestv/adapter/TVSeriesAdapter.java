package com.capstone.tubestv.adapter;
...
import com.capstone.tubestv.DetailActivity;
...
public class TVSeriesAdapter extends RecyclerView.Adapter<TVSeriesAdapter.ViewHolder> {
    ...
    private TVSeriesAdapter.onSelectData onSelectData;

    public interface onSelectData {
        void onSelected(ResultsItem mdlNews);

        void onSelected(RootTVSeriesModel mdlNews);
    }
