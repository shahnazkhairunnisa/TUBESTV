...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("poster") != null) {
            ...
            Glide.with(com.capstone.tubestv.DetailActivity.this)
                    .load(url)
            ...
            Glide.with(com.capstone.tubestv.DetailActivity.this).load(R.drawable.logo).into(ivPosterBgDetail);
            Glide.with(com.capstone.tubestv.DetailActivity.this).load(R.drawable.no_image).into(ivPosterDetail);
        }
